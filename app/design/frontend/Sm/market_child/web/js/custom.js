						...
						"owlcarousel"
						    ...
						    logos4.owlCarousel({
						     ...
						     $(".products-cat").owlCarousel({
                               items: 5,
                               responsive: {0: {items: 3, margin: 5},  480: { items: 3, margin: 5 }, 768: { items: 3 }, 992: { items: 4}, loop: true, 600: {items: 3}, 960: {items: 4}, 1200: {items: 5}},
			                    autoplay: false,
			                    loop: true,
			                    slideSpeed: 1000,
			                    margin: 15,
                            ...
                            $('.modal-popup .action-close').click(function (e) {
							...
							$(".main-megamenu-search .ves-megamenu li.subdynamic").hover(function () {
						     ...
						     var logos2 = $("#products");
							    logos2.owlCarousel({
							        ...
							        margin: 15,
							        items: 6,
							        responsive: {0: {items: 2}, loop: true, 600: {items: 3}, 960: {items: 3}, 1200: {items: 6}},
							        pagination: false
							    });
