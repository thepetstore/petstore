...
namespace IWD\BluePay\Model\Method;
...
//            throw new \LogicException('Public hash should be defined');
            /* Recheck old subscribers for order IWD*/
            $tokenData = isset($additionalInformation['token_metadata'])
                ? $additionalInformation['token_metadata']
                : null;

            if ($tokenData === null) {
                throw new \LogicException("Public hash should be defined or Token metadata should be defined");
            }
            ...
            $customerId = isset($additionalInformation['customer_id']) ?
                $additionalInformation['customer_id'] : null;
