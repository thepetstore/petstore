define(
    ...
    function ($,
        ...
        return Component.extend({
            ...
            isShowDelimiterAfterShippingMethods: quote.isShowComment() || quote.isShowMap() || quote.isShowGiftMessage(),
            isShowComment: quote.isShowComment(),
            isShowMap: quote.isShowMap(),
            commentValue: ko.observable(checkoutData.getComment()),
            isMap: ko.observable(checkoutData.getIsMap()),
