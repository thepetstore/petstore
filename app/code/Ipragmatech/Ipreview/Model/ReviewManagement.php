...
class ReviewManagement implements ReviewInterface
{
    ...
    public function getCategoryReviewsList($categoryId, $pageSize = 10, $currPage = 1, $orderBy = "entiry_id", $orderAs = 'desc')
    {
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        ...
        $categoryProducts = $category->getProductCollection()
            ...
            ->addAttributeToSort($orderBy, $orderAs)
        ...
        foreach ($categoryProducts as $product) {
           ...
           /* $data = [
            ...
            $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
            $storeId = $objectManager->get('\Magento\Store\Model\StoreManager')->getStore()->getId();
